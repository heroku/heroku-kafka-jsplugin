...
import Info from '../../../commands/kafka/info.js'
...
describe('kafka:info', () => {
  ...
  describe('with 2 clusters', () => {
    ...
    const attachments = [
      {addon: {name: 'kafka-1', id: '00000000-0000-0000-0000-000000000000', plan, addon_service}, name: 'KAFKA'},
      {addon: {name: 'kafka-1', id: '00000000-0000-0000-0000-000000000000', plan, addon_service}, name: 'HEROKU_KAFKA_COBALT'},
      {addon: {name: 'kafka-2', id: '00000000-0000-0000-0000-000000000001', plan, addon_service}, name: 'HEROKU_KAFKA_PURPLE'}
    ]
    const clusterA = {
      addon: {name: 'kafka-1'},
    ...
    it('shows kafka info', async () => {
      ...
      expect(stdout).to.include('Version: 0.10.0.0')
      expect(stdout).to.include('1 topic')
      expect(stdout).to.include('Customer Encryption Key: arn:aws:kms:us-east-1:123456789012:key/a1b23c4d-a1b2-c3d4-e5f6-a1b2c3d4e5f6')
      expect(stdout).to.include('Add-on: kafka-1')
